...
public class CrosshairTool implements PriorityMouseListener, PlotTool, PropertyChangeListener, Paintable {
	 ...
	 * knowledge of the CrosshairTool.
	 *
	 * @param plotPanel The plot to add cross-hair functionality to.
	 * @return The CrosshairTool added to the plot (most users will not need to
	 * store this reference).
	 */
	public static CrosshairTool addToPlot(PlotPanel plotPanel) {
		CrosshairTool t = new CrosshairTool();
		t.add(plotPanel);
		return t;
	}
