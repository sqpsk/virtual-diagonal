...
public abstract class AbstractSigGuiController<Parameters extends AbstractSigGuiParameters, Result> implements ISigGuiController {
...
//        view.clear();
    ...
    protected abstract AbstractSigGuiTask<Parameters, Result> newTask(Parameters parameters);
    ...
    private final PropertyChangeListener taskListener = new PropertyChangeListener() {
        ...
        public void propertyChange(PropertyChangeEvent pce) {
            if ("result".equals(pce.getPropertyName())) {
                AbstractSigGuiTask<Parameters, Result> task
                        = (AbstractSigGuiTask<Parameters, Result>) pce.getNewValue();
    ...
    private AbstractSigGuiTask<Parameters, Result> task = null;
