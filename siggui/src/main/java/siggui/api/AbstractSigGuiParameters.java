...
public abstract class AbstractSigGuiParameters implements Cloneable {

	public AbstractSigGuiParameters(long fileSizeSamples) {
	...
	@Override
	public abstract AbstractSigGuiParameters clone();
