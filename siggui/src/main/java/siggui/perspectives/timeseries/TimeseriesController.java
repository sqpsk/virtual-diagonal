...
class TimeseriesController extends AbstractPerspectiveController<TimeseriesParameters, TimeseriesResult> {
	...
	@Override
	protected void setResult(TimeseriesParameters p, TimeseriesResult result) {
